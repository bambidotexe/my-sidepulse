    ...
    private var cards: [Card] {
        ...
        return [
            ...
            Card(id: "codex-working", title: t.titleCodexWorking, subtitle: t.subtitleCodexWorking,
                 state: .working(.codex)),
            Card(id: "copilot-working", title: t.titleCopilotWorking, subtitle: t.subtitleCopilotWorking,
                 state: .working(.copilot)),
            Card(id: "opencode-working", title: t.titleOpenCodeWorking, subtitle: t.subtitleOpenCodeWorking,
                 state: .working(.opencode)),
            Card(id: "all-working", title: t.titleAllWorking, subtitle: t.subtitleAllWorking,
                 state: .working(.all)),
