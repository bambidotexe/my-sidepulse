...
/// exception the owner asked for: the two cards of the Tip page, which are pictures and words. A group
/// with no title is a card on its own, which only the Tip page's first card is.
///
