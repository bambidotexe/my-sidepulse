...
/// SHA-256 (FIPS 180-4), for the one hash Core has to reproduce: Codex's
/// trust hash of a hook (`CodexHookTrust`). Foundation has no digest of its
/// own, and Core takes no framework beyond it. `CodexHookTrustTests` holds it
