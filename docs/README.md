...
| [macOS.md](macOS.md) | The operating-system boundary: DiskArbitration and the eject guard, sleep and wake, battery, presence and focus inputs, process inspection, GitHub Copilot's hooks and process, OpenCode's plugin and server, permissions, launchd, the bundle and signing, logging. |
