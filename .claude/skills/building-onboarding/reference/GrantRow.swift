...
// localization helper (MySidepulse: Loc.onboarding, a table in Sources/MySidepulseCore/StringsOnboarding.swift
// answering for every Language).
// (In MySidepulse the live copies are Sources/MySidepulseApp/OnboardingCatalog.swift and
