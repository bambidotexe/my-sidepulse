...
// own localization helper (MySidepulse: Loc.onboarding, a table in
// Sources/MySidepulseCore/StringsOnboarding.swift answering for every Language).
// (In MySidepulse the live copy is Sources/MySidepulseApp/OnboardingWindowController.swift.)
